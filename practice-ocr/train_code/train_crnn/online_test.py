...
def valudate_model(val_dataset, model, gpu, converter):
    """ 模型评估"""
    num_all = 0
    num_correct = 0
    for batch_img, batch_label in val_dataset:
        # print(batch_img.size()) # torch.Size([1, 32, 280])
        image = batch_img.cuda() if gpu else batch_img
